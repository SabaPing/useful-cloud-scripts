...
function gcpKubeConfig(){
    KUBECONFIG=output/gcp.kubeconfig.yaml gcloud container clusters list --project $1 --region $2 | awk 'NR == 1 {next} {print $1}' | xargs -n 1 -I {} gcloud container clusters get-credentials {} --project $1 --region $2 || true
}
